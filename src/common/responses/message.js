...
export const VALIDATION_MESSAGES = {
    ...
    NOT_MATCH: (field1, field2) => `${field1} does not match ${field2}`,
    INVALID_VALUE: (field) => `Invalid ${field} value`,
    ...
    INVALID_FILE_TYPE: (allowedTypes) => `Invalid file type. Allowed: ${allowedTypes.join(', ')}`,
