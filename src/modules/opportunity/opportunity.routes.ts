...
// Opportunity routes
router.post("/create",verifyToken,ManagerAndadmin, opportunityController.createOpportunity);
...
router.put("/:id",verifyToken,ManagerAndadmin, opportunityController.updateOpportunity);
