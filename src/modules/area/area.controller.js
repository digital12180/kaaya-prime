...
import { validateCreateArea, validateUpdateArea } from "./area.dto.js";
export class AreaController {
    ...
    getAreaBySlug = async (req, res) => {
        try {
            const { slug } = req.params;
            const area = await this.areaService.getAreaBySlug(slug);
            res.status(200).json({
                success: true,
                message: "Area retrieved successfully",
                data: area
    ...
    // Get area statistics
    getAreaStatistics = async (req, res) => {
        try {
    ...
    checkSlugUniqueness = async (req, res) => {
        try {
            ...
            const isUnique = await this.areaService.isSlugUnique(slug, excludeId);
            res.status(200).json({
                success: true,
                data: {
                    slug,
    ...
    searchAreaByName = async (req, res) => {
        try {
