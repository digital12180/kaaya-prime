...
export class AreaService {
    ...
    async getAllAreas(paginationDto) {
    ...
    async updateArea(id, updateDto) {
        ...
        const area = await Area.findByIdAndUpdate(id, { ...updateData, updatedAt: new Date() }, { new: true, runValidators: true }).lean();
        if (!area) {
            throw new Error("Area not found");
        }
        return area;
