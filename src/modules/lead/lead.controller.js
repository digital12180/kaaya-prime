...
export class LeadController {
    ...
    getAllLeads = async (req, res) => {
        try {
            ...
            paginationDto.page = req.query.page ? parseInt(req.query.page) : 1;
            paginationDto.limit = req.query.limit ? parseInt(req.query.limit) : 10;
            paginationDto.search = req.query.search;
            paginationDto.source = req.query.source;
    ...
    // Get lead statistics
    getLeadStatistics = async (req, res) => {
        try {
    ...
    searchLead = async (req, res) => {
        try {
            const { name } = req.query;
            const result = await this.leadService.searchLead(name);
            res.status(200).json({
                success: true,
                message: "leads retrieved successfully",
                data: result
