...
import { validateCreateLandingPage, validateUpdateLandingPage, validateUpdateStatus } from "./landingPage.dto.js";
export class LandingPageController {
    ...
    getAllLandingPages = async (req, res) => {
        try {
            const paginationDto = {
    ...
    getLandingPageById = async (req, res) => {
        try {
            const { id } = req.params;
            const landingPage = await this.landingPageService.getLandingPageById(id);
            res.status(200).json({
                success: true,
    ...
    getLandingPageBySlug = async (req, res) => {
        try {
            const { slug } = req.params;
            const landingPage = await this.landingPageService.getLandingPageBySlug(slug);
            res.status(200).json({
                success: true,
                message: "Landing page retrieved successfully",
                data: landingPage
    ...
    getLandingPageBySlugAdmin = async (req, res) => {
        try {
            const { slug } = req.params;
            const landingPage = await this.landingPageService.getLandingPageBySlugAdmin(slug);
            res.status(200).json({
                success: true,
                message: "Landing page retrieved successfully",
                data: landingPage
    ...
    searchLandingPagesByTitle = async (req, res) => {
        try {
    ...
    updateLandingPage = async (req, res) => {
        try {
            ...
            const landingPage = await this.landingPageService.updateLandingPage(id, req.body);
            res.status(200).json({
                success: true,
    ...
    updateLandingPageStatus = async (req, res) => {
        try {
            const { id } = req.params;
            ...
            const landingPage = await this.landingPageService.updateLandingPageStatus(id, req.body);
            res.status(200).json({
                success: true,
    ...
    // Delete landing page
    deleteLandingPage = async (req, res) => {
        try {
            const { id } = req.params;
            const result = await this.landingPageService.deleteLandingPage(id);
            res.status(200).json({
                success: true,
    ...
    getLandingPagesByStatus = async (req, res) => {
        try {
            const { status } = req.params;
            const landingPages = await this.landingPageService.getLandingPagesByStatus(status);
            res.status(200).json({
                success: true,
    ...
    getLandingPagesByFormType = async (req, res) => {
        try {
            const { formType } = req.params;
            const landingPages = await this.landingPageService.getLandingPagesByFormType(formType);
            res.status(200).json({
                success: true,
    ...
    getPublishedLandingPages = async (req, res) => {
        try {
            const paginationDto = {
                page: req.query.page ? parseInt(req.query.page) : 1,
                limit: req.query.limit ? parseInt(req.query.limit) : 10,
    ...
    getLandingPageStatistics = async (req, res) => {
        try {
    ...
    bulkDeleteLandingPages = async (req, res) => {
        try {
            const { ids } = req.body;
    ...
    checkSlugUniqueness = async (req, res) => {
        try {
            ...
            const isUnique = await this.landingPageService.isSlugUnique(slug, excludeId);
            res.status(200).json({
                success: true,
                data: {
                    slug,
