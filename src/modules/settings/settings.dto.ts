...
export class SettingResponseDto implements ISettingResponseDto {
    _id: string;
    key: string;
    value: any;
    createdAt: Date;
...
export const validateCreateSetting = (data: any): string[] => {
    const errors: string[] = [];
...
export const validateUpdateSetting = (data: any): string[] => {
    const errors: string[] = [];
...
export const validateSettingValue = (key: string, value: any, expectedType?: string): string[] => {
    const errors: string[] = [];
